        ...
        try:
            ...
            if items:
                ...
                for item in items:
                    ...
                    get_child_sub_folders(service, current_id, level, Html_file, folders_only, folder_id, drivetype, parent_page_id, itemname, title, "KB")
...
def get_child_sub_folders(service, parent_id, level, Html_file, folders_only, folder_id, drivetype, parent_page_id, itemname, parent_title, ancestor_title):
        ...
        try:
            ...
            if items:
                ...
                for item in items:
                    ...
                    get_child_sub_folders(service, child_id, level, Html_file, folders_only, folder_id, drivetype, new_parent_page_id, childname, parent_title, files_title)
                page_token = results.get('nextPageToken')
                Html_file.write(""" </ul>""")
                if has_file:
                    ...
                    if title in created_pages:
                        ...
                        created_pages[title] += 1
                        # Append the count to make the title unique
                        title = f"{ancestor_title}_{files_title}_files"
                    else:
                        # Add the new title with a count of 0
                        created_pages[title] = 0
